...
%Biologists use something called an "Atlas" to determine the growth stage of a plant. These are usually 100 point scales with associated landmarks, where (approximately) 0 is a seed, and 100 is "dead". These atlases tend to be illustrated with sketches of the plants, and the determination of the growth stage of a particular plant is made with reference to the drawings and associated textual descriptions. This project would work with the National Plant Phenomics Centre to build a web-based visualisation of atlas-style information using real images of plants, gathered from their extensive database. A good project here would involve analysis of images, alignment, and representation of images, as well as web-based databases.

%explain the intial project
%talk about research done - atlas scale, plant terminology 
%talk about initial reason for doing the project
