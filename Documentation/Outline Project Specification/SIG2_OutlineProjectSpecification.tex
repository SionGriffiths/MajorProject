...
%==============================================================================
\begin{enumerate}
\item \textbf{Research the things} - In order to things then we need to make testings!
\item \textbf{Make the things} - We can make things such that things are good for humans
\item \textbf{Test the things} - Test are good. Things need to be test such that is good!
\end{enumerate}
...
%==============================================================================
\begin{enumerate}
\item \textbf{Deliver one thing} - We deliver the one things
\item \textbf{Deliver the two thing} - We can make things such that things are good for humans
\item \textbf{Delivery} - Test are good. Things need to be test such that is good!
\end{enumerate}
